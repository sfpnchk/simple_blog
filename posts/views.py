...
class PostDeleteView(LoginRequiredMixin, DeleteView):  # type:ignore
    model = Posts
    success_url = "/posts/"
...
class PostDetailView(DetailView):
    ...
    def get_object(self, queryset=None):
        return get_object_or_404(
            Posts, id=self.kwargs["pk"], status=Posts.PostStatus.PUBLISHED
        )
    ...
    def get_context_data(self, **kwargs):
        ...
        context["can_delete"] = (
            self.request.user.has_perm("posts.delete_news")
